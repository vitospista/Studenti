...
namespace CorsoEnaip2018_Stacks.Test
{
    ...
    public class StackTest
    {
        ...
        {
            var stack = new ObservableStack<int>(-14);
        }

        [TestMethod]
        public void Stack_with_0_capacity_cannot_Put()
        {
            var s = new ObservableStack<int>(0);
        ...
        {
            var s = new ObservableStack<int>(5);
        ...
        {
            var s = new ObservableStack<int>(2);
            s.Put(5);
        ...
        {
            var s = new ObservableStack<string>(2);
